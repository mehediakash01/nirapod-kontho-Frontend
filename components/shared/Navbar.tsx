  ...
  return (
    <nav 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-out ${
        isScrolled ? 'px-4 sm:px-6 lg:px-8 py-3 sm:py-4' : 'px-0 py-0'
      }`}
    >
      <div className={`max-w-7xl mx-auto transition-all duration-500 ease-out ${
        isScrolled
          ? 'bg-background/95 backdrop-blur-xl border border-primary/20 rounded-full shadow-lg px-4 sm:px-6 lg:px-8'
